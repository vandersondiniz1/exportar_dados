<?php
# ------------------------------------------------------------------------- #
# Script:        exportar_cpf.php
# Description:   responsavel por fazer um select na tabela a partir do cpf
...
#RECEBENDO O CPF VIA PARAMETRO HTML
$cpf = $_POST['cpf'];

#DECLARANDO OS TIPOS DE CABECALHOS DO ARQUIVO
header('Content-Type: text/csv; charset=utf-8');
header('Content-Disposition: attachment; filename=$export_cpf.csv');
